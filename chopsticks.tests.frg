...
pred thirteenMoveMax{
    // "The longest possible game that gets farther[clarification needed] from the starting point with each move is 9 moves."
    {next_state next_state next_state next_state next_state next_state next_state next_state next_state next_state next_state next_state not gameEnded
    and eventually doNothing} => 
    {next_state next_state next_state next_state next_state next_state next_state next_state next_state next_state next_state next_state next_state gameEnded}
}
...
run {
    ...
    thirteenMoveMax
} for exactly 2 Team, 4 Int, 4 Hand
...
test suite for tracesOfficialRules {
    test expect {
        ...
        // Correct maximum: 13 moves
        thirteenMoveMaxTracesOfficial :{
            {tracesOfficialRules[2] implies thirteenMoveMax}
        } for exactly 2 Team, 4 Int, 4 Hand is theorem
...
test suite for tracesOnlyGetsFarther {
    test expect {
        ...
        // Correct maximum
        thirteenMoveMaxTracesFarther :{
            {tracesOnlyGetsFarther[2] implies thirteenMoveMax}
        } for exactly 2 Team, 4 Int, 6 Hand is theorem
